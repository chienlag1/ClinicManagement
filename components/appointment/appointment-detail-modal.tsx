              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="font-medium">{patient?.name || 'Chưa có thông tin'}</p>
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm text-default-500">ID bệnh nhân</p>
                      <p className="font-medium">{patient?.patient_id || 'N/A'}</p>
                    </div>
                    <div className="space-y-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold">Thông tin lịch khám</h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-default-100 rounded-lg">
                        <p className="text-sm">{appointment.symptoms || 'Không có thông tin'}</p>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <p className="text-sm text-default-500">Bác sĩ phụ trách</p>
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="font-medium">{appointment.created_by || 'N/A'}</p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <p className="text-sm text-default-500">Cập nhật lần cuối</p>
                      <p className="font-medium">
                        {new Date(appointment.updatedAt).toLocaleDateString('vi-VN')}
                      </p>
                    </div>
                  </div>
                </div>
