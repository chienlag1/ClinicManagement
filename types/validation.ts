...
export const APPOINTMENT_VALIDATION_RULES = {
  ...
  appointment_date: VALIDATION_RULES.date('Ngày hẹn phải là ngày trong tương lai'),
  appointment_time: VALIDATION_RULES.time(),
  symptoms: VALIDATION_RULES.minLength(10, 'Mô tả triệu chứng tối thiểu 10 ký tự'),
};
